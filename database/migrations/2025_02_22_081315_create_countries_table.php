...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('countries', function (Blueprint $table) {
            $table->id();
            $table->char('code', length: 2); // Two-letter country code (ISO 3166-1 alpha-2)
            $table->string('name'); // English country name
            $table->string('full_name'); // Full English country name
            $table->char('iso3', length: 3); // Three-letter country code (ISO 3166-1 alpha-3)
            $table->char('number', length: 3); // Three-digit country number (ISO 3166-1 numeric)
            $table->char('continent_code', length: 2);
            $table->foreign('continent_code')
                ->references('code')
                ->on('continents');
        });

        $q = "INSERT INTO `continents` (`code`, `name`) VALUES
        ('AF', 'Africa'),
        ('AS', 'Asia'),
        ('EU', 'Europe'),
        ('NA', 'North America'),
        ...
        $q2 = 'INSERT INTO `countries` (`code`, `continent_code`, `name`, `iso3`, `number`, `full_name`) VALUES
